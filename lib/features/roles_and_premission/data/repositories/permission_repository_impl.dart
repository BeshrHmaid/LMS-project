...
class PermissionRepositoryImpl extends PermissionRepository {
  ...
  @override
  Future<Either<Failure, Unit>> addPermissions(List<Permission> permissions) async{
   try {
  ...
  @override
  Future<Either<Failure, List<Permission>>> getPermissions({String ? roleName})async {
  try {
      List<Permission>permissions= await permissionRemoteDataSource.getPermissions(roleName: roleName);
